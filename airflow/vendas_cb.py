...
@dag(schedule_interval=None, start_date=datetime(2022, 12, 13), catchup=False, tags=['example'])
def Vendas():
    """
    ...
    def pipeline_one():
        ...
        dadosp2 = pd.read_excel('data/vendas_pd/vendas_combustiveis.xlsx', engine="openpyxl", sheet_name='DPCache_m3')
        dadosp3 = pd.read_excel('data/vendas_pd/vendas_combustiveis.xlsx', engine="openpyxl", sheet_name='DPCache_m3_2')
        dadosp4 = pd.read_excel('data/vendas_pd/vendas_combustiveis.xlsx', engine="openpyxl", sheet_name='DPCache_m3_3')
        ...
        e.to_csv("data/vendas_pd/por_ano_e_combustivel_tuf.csv")
        f.to_csv("data/vendas_pd/por_ano_total.csv")
    ...
    def pipeline_two():
        ...
        dadosp3_q2 = pd.read_excel('data/vendas_pd/vendas_combustiveis.xlsx', engine="openpyxl", sheet_name='DPCache_m3_2')
        ...
        agrupamento2_2_q2.to_csv("data/vendas_pd/por_ano_e_tipo.csv")
        oleo_tipo_por_ano.to_csv("data/vendas_pd/por_ano_total_vendas_diesel.csv")
